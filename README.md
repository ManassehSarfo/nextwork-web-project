...
This project is used for an introoduction to creating and deploying a Java-based web app using AWS, espectially their tools.
...
1. Clone the repository:
    ```bash
    git clone https://github.com/manassehsarfo/nextwork-web-project.git
    ```
...
Manasseh - [email@example.com](mailto:email@example.com)
